...
execute if score #bbf_randval bbf_calc matches 9 run summon minecraft:item ~ ~0.7 ~ {Item:{id:"minecraft:iron_nugget",Count:13b}}
execute if score #bbf_randval bbf_calc matches 10 run summon minecraft:item ~ ~0.7 ~ {Item:{id:"minecraft:iron_nugget",Count:14b}}
execute if score #bbf_randval bbf_calc matches 11 run summon minecraft:item ~ ~0.7 ~ {Item:{id:"minecraft:iron_nugget",Count:15b}}
execute if score #bbf_randval bbf_calc matches 12 run summon minecraft:item ~ ~0.7 ~ {Item:{id:"minecraft:iron_nugget",Count:16b}}
execute if score #bbf_randval bbf_calc matches 13 run summon minecraft:item ~ ~0.7 ~ {Item:{id:"minecraft:iron_nugget",Count:17b}}